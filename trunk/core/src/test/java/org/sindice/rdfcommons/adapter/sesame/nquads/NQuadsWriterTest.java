...
public class NQuadsWriterTest {
    ...
    private static final Logger logger  = Logger.getLogger(NQuadsWriterTest.class);
    ...
    public void testWrite() throws RDFHandlerException {
        ...
        Assert.assertEquals(lines.length, 6, "Unexpected number of lines.");
    ...
    public void testReadWrite() throws RDFHandlerException, IOException, RDFParseException {
        ...
        Assert.assertEquals(baos.toString().split("\n").length, 400, "Unexpected number of lines.");
    }
