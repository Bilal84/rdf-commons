...
/**
 * Default deserializer for collections.
 *
 * @author Michele Mostarda (mostarda@fbk.eu)
 */
public class CollectionDeserializer extends BaseDeserializer {
    ...
    public <T> T deserialize(
        ...
        final List result = new ArrayList(sortableList.size());
    ...
    private Integer getItemIndex(QueryEndpoint endpoint, String member) {
    ...
    private String getItemValue(QueryEndpoint endpoint, String member) {
    ...
    private String getClassName(QueryEndpoint endpoint, String member) {
