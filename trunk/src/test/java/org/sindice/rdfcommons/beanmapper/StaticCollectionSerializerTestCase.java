 ...
 * @version $Id$
 */
public class StaticCollectionSerializerTestCase {
    ...
    public void testSerializerClassRecognition() {
        StaticCollectionSerializer collectionSerializer = new StaticCollectionSerializer();
        assert collectionSerializer.acceptClass(
