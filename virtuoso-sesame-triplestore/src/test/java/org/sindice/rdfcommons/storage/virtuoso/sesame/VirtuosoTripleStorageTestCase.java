...
/**
 * Test case for {@link org.sindice.rdfcommons.storage.virtuoso.sesame.VirtuosoTripleStorage}.
 *
...
public class VirtuosoTripleStorageTestCase {
    ...
    public static VirtuosoTripleStorageConfig createLocalTestConfig() {
        return new VirtuosoTripleStorageConfig(
            ...
            "http://default/graph/test/sesame",
            "dba",
            "dba"
        );
    }
    ...
    @BeforeClass
    public void setUp() throws MalformedURLException, StorageException {
     ...
     *
     * @throws org.sindice.rdfcommons.storage.StorageException
     */
    @Test
    ...
    public void testGetTriples() throws StorageException {
    ...
    private TripleSet getTBDTriples(String graphName) throws StorageException {
